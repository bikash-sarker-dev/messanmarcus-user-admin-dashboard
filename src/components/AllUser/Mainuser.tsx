...
//                           >
//                             <span
//                               className={`h-1.5 w-1.5 rounded-full ${u.isActive === "ACTIVE" ? "bg-green-500" : "bg-red-500"}`}
//                             />
//                             {u.isActive}
//                           </span>
//                         </td>
...
//                     <span className="ml-auto rounded-full bg-orange-100 px-2.5 py-0.5 text-[10px] font-semibold text-orange-500">
//                       {additionalMessage.length} chars
//                     </span>
//                   )}
//                 </div>
...
//                       className="ml-3 shrink-0 text-[11px] font-medium text-gray-400 underline transition-colors hover:text-red-400"
//                     >
//                       Clear
//                     </button>
//                   )}
...
//         recognition_values: details.values,
//         tone: details.tone,
//         ...(details.additionalMessage.trim() && {
//           userPrompt: details.additionalMessage.trim(),
//         }),
//       };
//       const res = await aiGenerateMassage(payload).unwrap();
//       setGeneratedData(res.data);
